export const errors = {
  ...
  ANNOUNCEMENT_RESOURCE_NOT_FOUND: 'ANNOUNCEMENT_RESOURCE_NOT_FOUND',
  ...
  DEPARTMENT_LEADERSHIP_NOT_FOUND: 'DEPARTMENT_LEADERSHIP_NOT_FOUND',
  ...
  EMPLOYEE_APPROVER_NOT_FOUND: 'EMPLOYEE_APPROVER_NOT_FOUND',
  EMPLOYEE_DOCUMENT_NOT_FOUND: 'EMPLOYEE_DOCUMENT_NOT_FOUND',
  EMPLOYEE_NOT_ACTIVE: 'EMPLOYEE_NOT_ACTIVE',
  EMPLOYEE_NOT_FOUND: 'EMPLOYEE_NOT_FOUND',
  EMPLOYEE_OVERTIME_ENTRY_REQUEST_NOT_FOUND: 'EMPLOYEE_OVERTIME_ENTRY_REQUEST_NOT_FOUND',
  EMPLOYEE_WORK_TIME_REQUEST_NOT_FOUND: 'EMPLOYEE_WORK_TIME_REQUEST_NOT_FOUND',
